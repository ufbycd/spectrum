...
u8 x;
/****************上半屏颜色控制********************************/
void SDA_RS(uchar i) { SDA_R1 = (_Bool)i; }
void SDA_GS(uchar i) { SDA_G1 = (_Bool)i; }
void SDA_BS(uchar i) { SDA_B1 = (_Bool)(i); }
void SDA_RGS(uchar i) { SDA_R1 = (_Bool)(i);SDA_G1 = (_Bool)(i); }
void SDA_GBS(uchar i) { SDA_G1 = (_Bool)(i); SDA_B1 = (_Bool)(i);}
void SDA_BRS(uchar i) { SDA_R1 = (_Bool)(i);SDA_B1 = (_Bool)(i); }
void SDA_BGRS(uchar i) { SDA_R1 = (_Bool)(i); SDA_G1 = (_Bool)(i);SDA_B1 = (_Bool)(i);}
...
/*******************下半屏颜色控制************************/
void SDA_R(uchar i) { SDA_R2 =(_Bool)i;}
void SDA_G(uchar i) { SDA_G2 = (_Bool)i; }
void SDA_B(uchar i) { SDA_B2 = (_Bool)i; }
void SDA_RG(uchar i) { SDA_R2 = (_Bool)i;SDA_G2 = (_Bool)i;}
void SDA_GB(uchar i) { SDA_G2 =(_Bool)i; SDA_B2 = (_Bool)i;}
void SDA_BR(uchar i) { SDA_R2 = (_Bool)i;SDA_B2 = (_Bool)i; }
void SDA_BGR(uchar i) { SDA_R2 =(_Bool)i; SDA_G2 = (_Bool)i;SDA_B2 = (_Bool)i;}
